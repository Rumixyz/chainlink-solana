...
type TxManager interface {
	...
	// - If an txID is provided, it will be used to identify the tx. Otherwise, a random UUID will be generated.
	// - The caller needs to set the tx.Message.RecentBlockhash and provide the corresponding lastValidBlockHeight.
	//   These values are obtained from the GetLatestBlockhash RPC call.
