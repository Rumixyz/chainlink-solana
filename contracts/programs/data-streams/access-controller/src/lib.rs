...
//! https://github.com/smartcontractkit/chainlink-solana/tree/develop/contracts/programs/access-controller
//! but with a different ProgramID
...
pub const MAX_ALLOW_LIST: usize = 64;

#[zero_copy]
pub struct AccessList {
    xs: [Pubkey; MAX_ALLOW_LIST],
    len: u64,
}
arrayvec!(AccessList, Pubkey, u64);
const_assert!(size_of::<AccessList>() == size_of::<u64>() + size_of::<Pubkey>() * MAX_ALLOW_LIST);
